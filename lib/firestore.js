...
const defaultContent = {
  ...
  about: {
    ...
    stats: [
      {
        number: "100+",
        label: "Medical & Surgical Missions",
        description: "",
      },
      {
        number: "50,000+",
      ...
      {
        number: "500+",
        label: "Surgical Procedures Performed",
        description: "",
      },
      {
        number: "10",
        label: "Satellite Hospitals Supporting Specialist Care",
        description: "",
      },
    ],
  ...
  missions: {
    cards: [
      ...
      },
      {
        ...
        pill: "What we see",
        title: "Our Vision",
        text: "Uniting Christian medical teams with skills and training to provide free, quality and compassionate care in lowâ€‘resource and conflictâ€‘stricken communities.",
      },
      {
        icon: "FaHeart",
        label: "Values",
  ...
  programs: {
    ...
    highlights: [
      ...
      { label: "Services", value: "Medical â€¢ Dental â€¢ Eye â€¢ HIV counseling" },
      { label: "Impact", value: "Serving hundreds in a single camp" },
      {
        label: "Approach",
        value: "Health education â€¢ Vaccination â€¢ Follow-up care",
      },
    ],
  ...
  medicalCamp: {
    ...
    description:
      "Relive the highlights from our recent outreach campâ€”stories, impact, and moments of hope brought to communities in need.",
    stats: [
  ...
  fundraising: {
    ...
    projectLead: {
      ...
      title: "Project lead",
      location: "Medical Center â€¢ Gulu",
      image: "/img/john.webp",
    },
    features: [
      {
  ...
  pages_contact: {
    ...
    addressLines: [
      "P.O. Box 421315, Mbararaâ€“Isingiro Road",
    ...
    scripture: {
      ref: "Mark 1:34",
      text: "â€¦and Jesus healed many who had various diseases. He also drove out many demons, but he would not let the demons speak because they knew who he was.",
    },
    socialLinks: [
  ...
  pages_press: {
    ...
    pressReleases: [
      {
        title: "Bring Healing to Northern Uganda â€” Help Save Lives Today",
        date: "April 5, 2025",
        description:
          "A successful medical camp delivered critical healthcare services to underserved communities in Northern Ugandaâ€”supporting screenings, surgeries, lab diagnostics, and health education with local partners.",
        image: "/images/press/press-release-hero.jpg",
        link: "https://doctorsonmissionint.org/",
      },
      {
        title: "Monthly Newsletter â€” March 2025",
        date: "March 1, 2025",
        description:
    ...
    outreaches: [
      {
        ...
        date: "7 Days â€¢ Paediatric Surgical Camp",
        excerpt:
      ...
      },
      {
        ...
        date: "2 Days â€¢ Community Medical Camp",
        excerpt:
